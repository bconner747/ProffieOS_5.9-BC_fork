...
public:
  ...
  const char* effectname() const {      // BC WaveLen mod
    return wav.effectname();            // BC WaveLen mod
  }                                     // BC WaveLen mod

  const char* effect2ndname() const {   // BC WaveLen mod
    return wav.effect2ndname();         // BC WaveLen mod
  }                                     // BC WaveLen mod
