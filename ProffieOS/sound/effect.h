...
class Effect {
...
#ifdef NO_REPEAT_RANDOM                         // BC NO REPEATING LAST SOUND!!! Thanks Profezzorn!
    switch (num_files) {
      default:
  ...
  // All files must start with this prefix.          // BC WavLen obirobkenobi mod  * This needs to be out of private:
  const char* name_;
