#ifndef SOUND_TALKIE_H    // talkieBCpersonal_wavs4dig
#define SOUND_TALKIE_H    // BC command parser wavs played for digits. Does not work as they overlap. need back-to-back playback delay....hmmm
...
#ifdef USE_WAVS_FOR_TALKIE
  void SayDigitWav(int digitwav) {
    switch (digitwav) {
      case 0: ::CommandParser::DoParse("play", "0.wav"); break;   // While these work ok for BC spoken battery level with cheating(delay), same problem with Lengthfinder and anything
                                                                  // How do you make a following wav wait until the first is finished? Need to play back-to-back files. Cheated again:
                                                                  // added delay() to the end of tens value below :( 
      case 1: ::CommandParser::DoParse("play", "1.wav"); break;
      case 2: ::CommandParser::DoParse("play", "2.wav"); break;
      case 3: ::CommandParser::DoParse("play", "3.wav"); break;
      case 4: ::CommandParser::DoParse("play", "4.wav"); break;
      case 5: ::CommandParser::DoParse("play", "5.wav"); break;
      case 6: ::CommandParser::DoParse("play", "6.wav"); break;
      case 7: ::CommandParser::DoParse("play", "7.wav"); break;
      case 8: ::CommandParser::DoParse("play", "8.wav"); break;
      case 9: ::CommandParser::DoParse("play", "9.wav"); break;
    }
  }

  void SayNumberWav(int n) {
    if (n == 0) {
      ::CommandParser::DoParse("play", "0.wav");
      return;
    }
    if (n / 1000000) {
      SayNumberWav(n/1000000);
      ::CommandParser::DoParse("play", "million.wav");
      n %= 1000000;
    }
    if (n / 1000) {
      SayNumberWav(n/1000);
      ::CommandParser::DoParse("play", "thousand.wav");
      n %= 1000;
    }
    if (n / 100) {
      ::CommandParser::DoParse("play", "1.wav");
      delay(430);
      ::CommandParser::DoParse("play", "hundred.wav");
      delay(730);
      n %= 100;
    }

    switch (n / 10) {
      case 9: ::CommandParser::DoParse("play", "90.wav"); delay (780); break;
      case 8: ::CommandParser::DoParse("play", "80.wav"); delay (780); break;
      case 7: ::CommandParser::DoParse("play", "70.wav"); delay (780); break;
      case 6: ::CommandParser::DoParse("play", "60.wav"); delay (780); break;
      case 5: ::CommandParser::DoParse("play", "50.wav"); delay (780); break;
      case 4: ::CommandParser::DoParse("play", "40.wav"); delay (780); break;
      case 3: ::CommandParser::DoParse("play", "30.wav"); delay (780); break;
      case 2: ::CommandParser::DoParse("play", "20.wav"); delay (780); break;
      case 1:
  switch (n) {
    case 19: ::CommandParser::DoParse("play", "19.wav"); return;
    case 18: ::CommandParser::DoParse("play", "18.wav"); return;
    case 17: ::CommandParser::DoParse("play", "17.wav"); return;
    case 16: ::CommandParser::DoParse("play", "16.wav"); return;
    case 15: ::CommandParser::DoParse("play", "15.wav"); return;
    case 14: ::CommandParser::DoParse("play", "14.wav"); return;
    case 13: ::CommandParser::DoParse("play", "13.wav"); return;
    case 12: ::CommandParser::DoParse("play", "12.wav"); return;
    case 11: ::CommandParser::DoParse("play", "11.wav"); return;
    case 10: ::CommandParser::DoParse("play", "10.wav"); return;
  }
    }
    n %= 10;
    if (n) SayDigitWav(n);
